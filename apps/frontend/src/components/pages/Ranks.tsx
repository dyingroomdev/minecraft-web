  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-16 text-center">
        <div className="bg-gradient-to-r from-yellow-500/10 via-amber-400/10 to-yellow-500/10 border border-yellow-500/40 rounded-lg p-8 max-w-2xl mx-auto mb-8">
          <Crown className="h-10 w-10 mx-auto mb-3 text-yellow-400" />
          <h2 className="text-2xl font-bold tracking-widest text-yellow-400 mb-2">
            PREMIUM RANKS WILL BE COMING SOON
          </h2>
          <p className="text-sm text-muted-foreground">
            Exclusive premium ranks with powerful perks are on the way. Stay tuned!
          </p>
        </div>
      </div>
