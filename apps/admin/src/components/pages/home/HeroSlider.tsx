...
export default function HeroSlider() {
  ...
  if (!data?.length) {
    return (
      <section className="mx-auto max-w-[1200px] px-6 py-14 text-center text-sm text-muted-foreground">
        No hero slides found. Add active slides in the admin panel to showcase announcements.
      </section>
    );
  }
