"""Minecraft server query and RCON services."""
    ...
    async def query(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'ping': 0  # Would need separate ping measurement
            }
        except Exception:
            return {
                'status': 'offline',
...
class ServerStatusPoller:
    ...
    def __init__(self, settings: Settings, session: AsyncSession, redis: aioredis.Redis):
    ...
    async def start(self) -> None:
        ...
        while self._running:
            try:
                ...
                await asyncio.sleep(min(60, 10 * 2))  # Simple backoff
